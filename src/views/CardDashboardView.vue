    ...
    <div class="mt-5 grid grid-cols-1 rounded-lg bg-white overflow-hidden shadow divide-y divide-gray-200 md:grid-cols-3 md:divide-y-0 md:divide-x">
      ...
      <div class="px-4 py-5 sm:p-6">
        ...
        <dd class="mt-1 flex justify-between items-baseline md:block lg:flex">
          <div class="flex items-baseline text-2xl font-semibold text-indigo-600">
            3
            <span class="ml-2 text-sm font-medium text-gray-500"> out of 4 </span>
          </div>
        </dd>
      </div>
...
const stats = [
  { name: 'Total Task', stat: '71,897', previousStat: '70,946', change: '12%', changeType: 'increase' },
